        ...
        <Page>
            <StyledPrivacyPolicy>
                ...
                <Button as="a" href="/" scale="sm">
                    ...
                    <Heading color ="primary" scale="xl">Privacy Policy</Heading>
                    <LogoIcon scale="sm" mb="4px" mt="4px" />
                    <Heading color ="text">September 3, 2021</Heading>

                <Text>
                <p>Your privacy is important to us. It is KogeFarm&aposs policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://kogefarm.io, and other sites we own and operate.</p>

                <p>This policy is effective as of 3 September 2021 and was last updated on 3 September 2021.</p>

               <Heading color="secondary">Information We Collect</Heading>
                ...
                <Heading color="secondary">Log Data</Heading>
                ...
                <Heading color="secondary">Collection and Use of Information</Heading>
                ...
                <Heading color="secondary">Security of Your Personal Information</Heading>
                ...
                <Heading color="secondary">How Long We Keep Your Personal Information</Heading>
                ...
                <Heading color="secondary">Children’s Privacy</Heading>
                ...
                <Heading color="secondary">International Transfers of Personal Information</Heading>
                ...
                <Heading color="secondary">Your Rights and Controlling Your Personal Information</Heading>
                ...
                <Heading color="secondary">Limits of Our Policy</Heading>

                <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices.</p>

                <Heading color="secondary">Changes to This Policy</Heading>
                ...
                <Heading color="secondary">Contact Us</Heading>
