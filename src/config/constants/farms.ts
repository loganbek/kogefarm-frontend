...
*/
...

  {
    ...
    rewardPerBlock: 15,
    poolWeightDesignate: 1000/11550,
    minutesPerCompound: 5,
    kogefarmFee: 0.01,
...

  {
    ...
    quoteToken: tokens.usdc,
    rewardPerBlock: 15,
    poolWeightDesignate: 2000/11550,
    minutesPerCompound: 5,
    kogefarmFee: 0.01,
    underlyingWebsite: 'https://polygon.cafeswap.finance/farms',
    isCafeSwap: true,
...

  {
    ...
    rewardPerBlock: 15,
    poolWeightDesignate: 3000/11550,
    minutesPerCompound: 5,
    kogefarmFee: 0.01,
    underlyingWebsite: 'https://polygon.cafeswap.finance/farms',
    isCafeSwap: true,
...

  {
    ...
    rewardToken: tokens.pbrew,
    rewardPerBlock: 15,
    poolWeightDesignate: 1800/11550,
    minutesPerCompound: 5,
    kogefarmFee: 0.01,
    underlyingWebsite: 'https://polygon.cafeswap.finance/farms',
    isCafeSwap: true,
...

  {
    ...
    rewardToken: tokens.beta,
    rewardPerBlock: 0.0131,
    poolWeightDesignate: 1800/10000,
    minutesPerCompound: 5,
    kogefarmFee: 0.01,
    underlyingWebsite: 'https://polybeta.finance/',
    platform: 'PolyBeta'
...

  {
    ...
    jarAddresses: {
      80001: '',
      137: '0x90a1977eD401c86274b87AfD95D0685edD2cE2ca',
    },
    token: tokens.alpha,
    quoteToken: tokens.usdc,
    rewardToken: tokens.beta,
...

  {
    ...
    platform: 'DFYN'
...

          {
            ...
            rewardPerBlock: 0.00011574074074074*2,
            poolWeightDesignate: 1,
            minutesPerCompound: 1,
            kogefarmFee: 0.01,
...

          {
            ...
            quoteToken: tokens.matic,
            rewardToken: tokens.quick,
            rewardPerBlock: 0.000034828662367724*2,
            poolWeightDesignate: 1,
            minutesPerCompound: 1,
            kogefarmFee: 0.01,
            underlyingWebsite: 'https://quickswap.exchange/#/quick',
...
*/

          {
            ...
            rewardPerBlock: 1.19,
            poolWeightDesignate: 4000/39500,
            minutesPerCompound: 5,
            kogefarmFee: 0.01,
...

          {
            ...
            quoteToken: tokens.matic,
            rewardPerBlock: 1.19,
            poolWeightDesignate: 5500/39500,
            minutesPerCompound: 5,
            kogefarmFee: 0.01,
            underlyingWebsite: 'https://polyshield.finance/#/vaults',
            platform: 'PolyShield'
...

          {
            ...
            rewardPerBlock: 1.19,
            poolWeightDesignate: 3500/39500,
            minutesPerCompound: 5,
            kogefarmFee: 0.01,
            underlyingWebsite: 'https://polyshield.finance/#/vaults',
            platform: 'PolyShield',
...
*/
...

        {
          ...
          rewardToken: tokens.ice,
          rewardPerBlock: 15.527256944444444444*2,
          poolWeightDesignate: 7300/97933,
          minutesPerCompound: 1,
          kogefarmFee: 0.01,
          kogefarmComment: ' (Iron)',
          underlyingWebsite: 'https://app.iron.finance/',
...
*/
...

   {
     ...
     quoteToken: tokens.matic,
     rewardToken: tokens.quick,
     rewardPerBlock: 0.000000000001157407407407*2,
     poolWeightDesignate: 1,
     minutesPerCompound: 5,
     kogefarmFee: 0,
...

   {
     ...
     quoteToken: tokens.eth,
     rewardToken: tokens.quick,
     rewardPerBlock: 0.000162037037037037*2,
     poolWeightDesignate: 1,
     minutesPerCompound: 5,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://quickswap.exchange',
...

   {
     ...
     quoteToken: tokens.matic,
     rewardToken: tokens.quick,
     rewardPerBlock: 0.000023148148148148*2,
     poolWeightDesignate: 1,
     minutesPerCompound: 5,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://quickswap.exchange',
