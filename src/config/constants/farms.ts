...
*/
   ...
   */
...

   {
     ...
     poolWeightDesignate: 14000/27500,
     minutesPerCompound: 5,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://dinoswap.exchange/',
     isSushi: true,
...

   {
     ...
     rewardToken: tokens.dino,
     rewardPerBlock: 14.1319444444445,
     poolWeightDesignate: 4000/27500,
     minutesPerCompound: 5,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://dinoswap.exchange/',
   },

   {
     ...
     rewardToken: tokens.dino,
     rewardPerBlock: 14.1319444444445,
     poolWeightDesignate: 1000/27500,
     minutesPerCompound: 5,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://dinoswap.exchange/',
...

   {
     ...
     kogefarmComment: ' (QuickSwap)',
...

      {
        ...
        poolWeightDesignate: 1000/3075*4.97/3.18,
        minutesPerCompound: 5,
        kogefarmFee: 0.01,
        depositFee: 0.001,
...

      {
        ...
        rewardPerBlock1: 14.1319444444445*500/27500*1/25.676689234842104069, // 0.8064
...

      {
        ...
        rewardToken1: tokens.dino,
        rewardToken2: tokens.pswamp,
        rewardPerBlock1: 14.1319444444445*500/27500*1/285509.63173326221286833, // 0.8064
        rewardPerBlock2: 0.107205733*25/3075,
        poolWeightDesignate: 1,
        minutesPerCompound: 5,
        kogefarmFee: 0.01,
...

      {
        ...
        rewardToken1: tokens.dino,
        rewardToken2: tokens.pswamp,
        rewardPerBlock1: 14.1319444444445*500/27500*1/0.328709096213253214, // 0.8064
        rewardPerBlock2: 0.107205733*25/3075,
        poolWeightDesignate: 1,
        minutesPerCompound: 5,
        kogefarmFee: 0.01,
...

      {
        ...
        rewardToken1: tokens.dino,
        rewardToken2: tokens.pswamp,
        rewardPerBlock1: 14.1319444444445*1000/27500*1/0.00006966032642713, // 0.8064
        rewardPerBlock2: 0.107205733*25/3075,
        poolWeightDesignate: 1,
        minutesPerCompound: 5,
        kogefarmFee: 0.01,
...

       {
         ...
         rewardPerBlock2: 0.107205733*50/3075,
         poolWeightDesignate: 1,
         depositFee: 0.001,
         minutesPerCompound: 5,
         kogefarmFee: 0.01,
...

  {
...

   {
     ...
     quoteToken: tokens.usdc,
     rewardPerBlock: 0.1,
     poolWeightDesignate: 12000/63900,
     minutesPerCompound: 1,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://polywantsacracker.farm/',
   },

   {
     ...
     quoteToken: tokens.matic,
     rewardPerBlock: 0.1,
     poolWeightDesignate: 4000/63900,
     minutesPerCompound: 1,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://polywantsacracker.farm/',
   },
...
/*   {
...

   {
     ...
     rewardPerBlock: 26.194157016744633442,
...
/* We seem to be dramatically underestimating trading fees compared to Quick. A hack to compensate */

      {
        ...
        rewardPerBlock: 2,
        poolWeightDesignate: 7000/21155,
        minutesPerCompound: 1,
        kogefarmFee: 0.01,
        isApe: true,
...
/*
...

      {
        ...
        quoteToken: tokens.eth,
        rewardPerBlock: 2,
        poolWeightDesignate: 1750/21155,
        minutesPerCompound: 1,
        kogefarmFee: 0.01,
        isApe: true,
        rewardToken: tokens.crystl,
