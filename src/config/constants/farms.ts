...
*/
...

   {
     ...
     kogefarmComment: ' (QuickSwap)',
...

      {
        ...
        poolWeightDesignate: 1000/2125*7.27/5.21,
        minutesPerCompound: 5,
        kogefarmFee: 0.01,
        depositFee: 0.001,
...

      {
        ...
        token: tokens.pswamp,
        quoteToken: tokens.matic,
        rewardPerBlock: 0.107205733*7.31/5.94,
        poolWeightDesignate: 500/2125,
        minutesPerCompound: 5,
        depositFee: 0.001,
        kogefarmFee: 0.01,
        underlyingWebsite: 'https://swamp.finance/polygon/',
...

      {
        ...
        rewardToken1: tokens.dino,
        rewardToken2: tokens.pswamp,
        rewardPerBlock1: 14.1319444444445*500/24500*0.904/32.772, // 0.8064
        rewardPerBlock2: 0.107205733*25/2375,
        poolWeightDesignate: 1,
        minutesPerCompound: 5,
        kogefarmFee: 0.01,
...

  {
...

   {
     ...
     rewardPerBlock: 0.1,
     poolWeightDesignate: 10500/50375,
     minutesPerCompound: 1,
     kogefarmFee: 0.01,
...

   {
     ...
     quoteToken: tokens.usdc,
     rewardPerBlock: 0.1,
     poolWeightDesignate: 10000/50375,
     minutesPerCompound: 1,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://polywantsacracker.farm/',
   },

   {
     ...
     quoteToken: tokens.matic,
     rewardPerBlock: 0.1,
     poolWeightDesignate: 3500/50375,
     minutesPerCompound: 1,
     kogefarmFee: 0.01,
     underlyingWebsite: 'https://polywantsacracker.farm/',
   },
