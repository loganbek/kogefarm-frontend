...
*/
   ...
   */
...

   {
     ...
     rewardPerBlock1: 0.8066*4.95/8.75, // 0.8064
     rewardPerBlock2: 0.295*4.95/8.75,
...

   {
     ...
     rewardToken1: tokens.matic,
     rewardToken2: tokens.crv,
     rewardPerBlock1: 0.4575*45.8/81.21, // 0.4575
     rewardPerBlock2: 0.2899*45.8/81.21, // 0.2899
     poolWeightDesignate: 1,
     minutesPerCompound: 5,
     kogefarmFee: 0.01,
     kogefarmComment: ' (Curve)',
...

  {
    ...
    rewardToken1: tokens.matic,
    rewardToken2: tokens.crv,
    rewardPerBlock1: 0.208*5.35/8.75, // 0.22
    rewardPerBlock2: 0.1316*5.35/8.75, // 0.1315
    poolWeightDesignate: 1,
    minutesPerCompound: 1,
    kogefarmFee: 0,
    kogefarmComment: ' (Curve)',
...

  {
    ...
    rewardPerBlock: 15.527256944444444444*2,
    poolWeightDesignate: 33333/97933,
    minutesPerCompound: 1,
    kogefarmFee: 0.01,
...

  {
    ...
    rewardToken: tokens.ice,
    rewardPerBlock: 15.527256944444444444*2,
    poolWeightDesignate: 14600/97933,
    minutesPerCompound: 1,
    kogefarmFee: 0.01,
    kogefarmComment: ' (Iron)',
    underlyingWebsite: 'https://app.iron.finance/',
...

  {
    ...
    quoteToken: tokens.usdc,
    rewardPerBlock: 15.527256944444444444*2,
    poolWeightDesignate: 25000/97933,
    minutesPerCompound: 1,
    kogefarmFee: 0.01,
    isDfyn: true,
...
/*
...

   {
     ...
     rewardPerBlock: 0.000003490611770783*2,
     poolWeightDesignate: 1,
     minutesPerCompound: 5,
     kogefarmFee: 0,
...
/*
...

  {
...

       {
         ...
         rewardToken2: tokens.pswamp,
         rewardPerBlock1: 0.000798611111111111*2*0.96, // 0.8064
         rewardPerBlock2: 0.107205733*25/2850,
         depositFee: 0.001,
         poolWeightDesignate: 1,
         minutesPerCompound: 5,
...

       {
         ...
         rewardToken1: tokens.quick,
         rewardToken2: tokens.pswamp,
         rewardPerBlock1: 0.000462962962962962*2*0.96, // 0.8064
         rewardPerBlock2: 0.107205733*25/2850,
         poolWeightDesignate: 1,
         depositFee: 0.001,
         minutesPerCompound: 5,
...

       {
         ...
         rewardToken1: tokens.quick,
         rewardToken2: tokens.pswamp,
         rewardPerBlock1: 0.00011574074074074*2*1/0.328472542024626154*0.96, // 0.8064
...

   {
     ...
     platform: 'PolyRoll'
...

         {
           ...
           rewardPerBlock: 0.05,
           poolWeightDesignate: 5500/58400,
           minutesPerCompound: 1,
           kogefarmFee: 0.01,
...

          {
            ...
            quoteToken: tokens.usdc,
            rewardPerBlock: 0.05,
            poolWeightDesignate: 10000/58400,
            minutesPerCompound: 1,
            kogefarmFee: 0.01,
            underlyingWebsite: 'https://ball.polypup.finance/',
            platform: 'PolyPup'
...

          {
            ...
            rewardPerBlock: 0.05,
            poolWeightDesignate: 1500/58400,
            minutesPerCompound: 1,
            kogefarmFee: 0.01,
            underlyingWebsite: 'https://ball.polypup.finance/',
...

          {
            ...
            rewardToken: tokens.ball,
            rewardPerBlock: 0.05,
            poolWeightDesignate: 2000/58400,
            minutesPerCompound: 1,
            depositFee: 0.04,
            kogefarmFee: 0.01,
            underlyingWebsite: 'https://ball.polypup.finance/',
...

          {
            ...
            rewardPerBlock: 0.05,
            depositFee: 0.04,
            poolWeightDesignate: 1800/58400,
            minutesPerCompound: 1,
            kogefarmFee: 0.01,
            underlyingWebsite: 'https://ball.polypup.finance/',
            kogefarmComment: ' (Ball)',
...

          {
            ...
            rewardToken: tokens.ball,
            rewardPerBlock: 0.05,
            poolWeightDesignate: 2300/58400,
            minutesPerCompound: 1,
            depositFee: 0.04,
            kogefarmFee: 0.01,
            underlyingWebsite: 'https://ball.polypup.finance/',
...
/* We seem to be dramatically underestimating trading fees compared to Quick. A hack to compensate */

      {
        ...
        rewardPerBlock: 1.5,
        poolWeightDesignate: 7000/21695,
        minutesPerCompound: 1,
        kogefarmFee: 0.01,
        isApe: true,
...
/*
...

      {
        ...
        quoteToken: tokens.eth,
        rewardPerBlock: 1.5,
        poolWeightDesignate: 1750/21695,
        minutesPerCompound: 1,
        kogefarmFee: 0.01,
        isApe: true,
        rewardToken: tokens.crystl,
