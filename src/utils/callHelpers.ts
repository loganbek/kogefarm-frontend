...
export const depositJar = async (jarContract, amount, account) => {
  ...
  return jarContract.methods
    ...
    .send({ from: account, gas: 800000, gasPrice:'10000000000' })
    .on('transactionHash', (tx) => {
      return tx.transactionHash
    })
}
...
export const sousStake = async (sousChefContract, amount, decimals = 18, account) => {
  return sousChefContract.methods
    ...
    .send({ from: account, gas: 400000, gasPrice:'10000000000' })
    .on('transactionHash', (tx) => {
      return tx.transactionHash
    })
}
...
export const sousStakeBnb = async (sousChefContract, amount, account) => {
  return sousChefContract.methods
    .deposit()
    .send({ from: account, gas: 400000, gasPrice:'10000000000', value: new BigNumber(amount).times(DEFAULT_TOKEN_DECIMAL).toString() })
    .on('transactionHash', (tx) => {
      return tx.transactionHash
    })
}
...
export const soushHarvestBnb = async (sousChefContract, account) => {
  return sousChefContract.methods
    .deposit()
    .send({ from: account, gas: 400000, gasPrice:'10000000000', value: BIG_ZERO })
    .on('transactionHash', (tx) => {
      return tx.transactionHash
    })
}
