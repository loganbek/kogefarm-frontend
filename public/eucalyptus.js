...
// let kogeLogoCSS = document.createElement('link')

// set the attributes for link element
// kogeLogoCSS.rel = 'stylesheet'

// kogeLogoCSS.type = 'text/css'

// kogeLogoCSS.href = 'eucalyptus.css'

// elementReady('head').then(kogeCSSAnchor => {
//   kogeCSSAnchor.appendChild(kogeLogoCSS)
// })
...
// head.appendChild(kogeLogoCSS)

// * REMOVAL

// elementReady('#root > div.sc-dkQUaI.hHItVm > nav > div:nth-child(1) > a').then(panLink => {
//   panLink.remove()
// })

elementReady('#root > div > nav > div > a').then(panLink => {
...
/* <a href="/"><img src="<img src='https://kogecoin.io/images/logo.png" alt="KogeKoinFarm | Home"></a> */

// let kogeLogoAnchor = document.createElement('a')
// kogeLogoAnchor.href = '/'
// kogeLogoAnchor.innerHTML = '<img id="kogeLogoImage" src="/images/kogeLogoWhite.png" alt="KogeCoinFarm | Home">'
// kogeLogoAnchor.id = 'kogeLogoAnchor'
// let kogeLogoDiv = document.createElement('div')
// kogeLogoDiv.id = 'kogeLogoDiv'
// kogeLogoDiv.appendChild(kogeLogoAnchor)
// // document.querySelector('button').append(kogeLogoDiv)

// elementReady('button:first-of-type').then(kogeLogoParent => {
//   kogeLogoParent.appendChild(kogeLogoDiv)
// })

// * REMOVE BOTTOM PANEL
// div#root > div > div > div > div:nth-of-type(2) > div
elementReady('div#root > div > div > div > div:nth-of-type(2) > div').then(bottomPanel => {
  bottomPanel.remove()
})
...
// let kogeTelegramSelector =
//   '#root > div.sc - dkQUaI.hHItVm > div > div.sc - dFRpbK.fkOwX > div.sc - bXexck.kxzaHP > div.sc - csTbgd.gEOQev > a'

// elementReady(kogeTelegramSelector).then(kogeTelegramLink => {
//   kogeTelegramLink.href = 'https://t.me/kogecoin/'
// })

// * Twitter

// elementReady(
//   '#root > div.sc-dkQUaI.hHItVm > div > div.sc-dFRpbK.fkOwX > div.sc-bXexck.kxzaHP > div.sc-csTbgd.gEOQev > div > a',
// ).then(kogeTwitterLink => {
//   kogeTwitterLink.href = 'https://twitter.com/kogecoin/'
// })
...
// let kogeIconLinkSelector = 'div#root > div > div > div > div:nth-of-type(2) > div > a'
// // let qsDiv = document.createElement(`div`)
// let qsLogo = document.createElement('img')
// qsLogo.id = 'quickSwapLogo'
// qsLogo.src = '/images/quickSwapLogoSmall.png'
// qsLogo.style.marginLeft = '5px'
// // qsDiv.appendChild(qsLogo)

// elementReady(kogeIconLinkSelector).then(kogeIconLink => {
//   kogeIconLink.href = 'https://quickswap.exchange/#/swap?outputCurrency=0x13748d548d95d78a3c83fe3f32604b4796cffa23'
//   while (kogeIconLink.firstChild) {
//     kogeIconLink.removeChild(kogeIconLink.lastChild)
//   }
//   //   kogeIconLink.width = '50px'
//   //   kogeIconLink.margin =
//   kogeIconLink.color = 'white'
//   kogeIconLink.innerHTML = 'Buy on' + qsLogo.outerHTML
//   //   kogeIconLink.innerHTML.color = 'white'
// })

// document.querySelector(kogeIconLinkSelector).style.color = `white`
// copy outer html and restore
// div#root > div > div > div > div: nth - of - type(2) > div

// bottomPanel = document.querySelector('div#root > div > div > div > div:nth-of-type(2) > div')

// kogeIconLink.textContext = ''

// kogeIconLink.appendChild('<img src="/images/quickSwapLogoSmall.png>')

// * KogePrice
// REMOVE

//'#root > div.sc-dkQUaI.hHItVm > div > div.sc-dFRpbK.fkOwX > div.sc-bXexck.kxzaHP > div.sc-csTbgd.gEOQev > a > div',
// '/html/bdoy / div / div[1] / div / div[1] / div[2] / div[1] / a / div'

// kogePriceElement = document.querySelector('/html/bdoy / div / div[1] / div / div[1] / div[2] / div[1] / a / div')

// kogePriceElement.remove()

// let kogePriceSelector =
//   '#root > div.sc - dkQUaI.hHItVm > div > div.sc - dFRpbK.fkOwX > div.sc - bXexck.kxzaHP > div.sc - csTbgd.gEOQev > a > div'

// elementReady(kogePriceSelector).then(kogePrice => {
//   kogePrice.innerHTML = ~'$0.003'
// })

// <a
//   href='https://pancakeswap.info/token/0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82'
//   target='_blank'
//   class='sc-gsWcmt boRhqI'
// >
//   <svg viewBox='0 0 90 90' width='24px' color='text' xmlns='http://www.w3.org/2000/svg' class='sc-bdnxRM fIQtFU'>
...
//     </defs>
//   </svg>
//   <div color='textSubtle' class='sc-gtsrHT hEGjXV'>
//     $100.000
//   </div>
// </a>
